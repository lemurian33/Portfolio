...
export const metadata: Metadata = {
  title: `S'inscrire | ${SiteConfig.title}`,
  description:
    "Créez votre compte pour commencer à recueillir des témoignages percutants pour vos projets.",
};
  ...
  return (
    <Card className="mx-auto w-full max-w-md lg:max-w-lg lg:p-6">
      <CardHeader className="flex flex-col items-center justify-center gap-1">
        ...
        <CardTitle>S'inscrire sur {SiteConfig.title}</CardTitle>
        <CardDescription>
          Nous avons besoin de quelques détails pour commencer.
        </CardDescription>
      </CardHeader>
      <CardContent>
